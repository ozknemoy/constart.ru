...
(function () {
    ...
    CKEDITOR.config.plugins = 'dialogui,dialog,clipboard,button,toolbar,enterkey,entities,floatingspace,wysiwygarea,indent,indentlist,fakeobjects,link,list,undo,youtube,colordialog,image,panel,floatpanel,menu,contextmenu,liststyle,pastefromword,table,tabletools,tableresize,listblock,richcombo,stylescombo';
